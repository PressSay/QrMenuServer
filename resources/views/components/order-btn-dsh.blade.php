...
<div class="sm:w-96 h-44 rounded-tr-xlarge rounded-bl-xlarge shadow-xl relative mx-2 my-4"
    ...
    <div class="absolute h-full w-full">
        <div class="w-full h-1/2 rounded-tr-xlarge" style="background-color: #DAE7CA;"></div>
        <div class="w-full h-1/2 rounded-bl-xlarge bg-minus" style="background-color: white/* #FFDAD6 */;"></div>
    </div>
    <div class="absolute flex flex-col">
        <div class="flex mb-3">
            ...
            <div class="flex flex-col sm:w-52 w-2/3  ml-2 relative">
                ...
                <p class="text-base text-center font-bold text-sm" style="color: #3C691B">{{ $title }}</p>
                <p class="text-sm font-bold text-sm">{{ $description }}</p>
                <p class="text-xs h-20 text-ellipsis overflow-hidden">
                    {{ $messDscript }}
                </p>
            </div>
        </div>
        <div class="flex mb-2">
            <div class="w-40 flex justify-center">
                <p class="w-20 text-center rounded-tr-md rounded-bl-md text-white font-bold text-sm"
            ...
            <div class="flex justify-center sm:w-52 w-full ml-4 relative">
                <svg class="w-5 absolute right-3 bottom-2" width="28" height="3" viewBox="0 0 28 3"
                    ...
                    <path d="M0 3V0H28V3H0Z" fill="#BA1A1A" />
                </svg>
                <p class="w-20 text-center rounded-tr-md rounded-bl-md text-white font-bold text-sm quantity"
                    style="background: #3C691B;">
                    {{ $quantity }}
                </p>
            </div>
